...
class UiTests {
    ...
    [STAThread] static int Main(string[] args) {
        ...
        using(var f=new MainForm(new Storage(args[2]))) {
            ...
            Call(f,"Rest"); Check(!(bool)plugin.GetType().GetProperty("Enabled").GetValue(plugin,null),"Rest disables capture immediately");
        ...
        using(var reminder=(Form)Activator.CreateInstance(t,new object[]{"ko",0,(Action)delegate{},(Action)delegate{}})) {
